...
# To recombine, use: cat points.tar.xz.part* | tar -xJv
# To recombine, use: cat faces.tar.xz.part* | tar -xJv
# find . -size +50M -print  # Finds files and directories larger than 50MB
# Usage: ./compress_and_split_efile.sh <file_path>
